...
public class PutData1 {
    ...
    public static void main(String[] args) throws MasterNotRunningException, IOException {
        ...
        sizeOfList = 0;
        readFromXlsx("/home/shang/repo/myHBaseProject/HbaseDataGenerate/test/data/data_from_1-1_sorted.xlsx");

        ArrayList<Put> puts = new ArrayList<>(sizeOfList);
        for (int i = 0; i < sizeOfList; i++) {
            Put put = new Put(Bytes.toBytes(phoneNums.get(i)));
            put.addColumn(Bytes.toBytes("pos"), Bytes.toBytes(positionCodes.get(i)), ts.get(i), Bytes.toBytes(placeCodes.get(i)));
            puts.add(put);
            put = null;
        }
        ...
        // put.addColumn(Bytes.toBytes("personal"), Bytes.toBytes("name"), Bytes.toBytes("Tom"));
        // table.put(put);
